...
router.post('/create-shop', fileUploader.single('image'), (req, res, next) => {
  ...
  const { name, type, location, description, transport, website, rating } = req.body

  cafeteria
    .create({ name, type, image: req.file.path, location, description, transport, website, rating })
